...
namespace Robot {
/**
 * @brief A base for any sink in Robot to implement.
 *
 * Sinks are Robot's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * Robot::BaseSink combinedSink({Robot::telemetrySink(), Robot::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(Robot::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[Robot] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
