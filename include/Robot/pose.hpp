...
class Pose {
    public:
         ...
         * @code {.cpp}
         * // create a pose
         * Robot::Pose poseA(5, // x position
         *                    10, // y position
         *                    1.57); // heading
         * // create a pose
         * Robot::Pose poseB(5.2, 22); // x and y position, heading defaults to 0
         * @endcode
         */
         ...
         * @code {.cpp}
         * // create a pose
         * Robot::Pose poseA(5, 10, 1.57);
         * // create a pose
         * Robot::Pose poseB(5.2, 22, 2.22);
         * // add the two poses
         * Robot::Pose poseC = poseA + poseB;
         ...
         * @code {.cpp}
         * // create poses
         * Robot::Pose poseA(0, 0);
         * Robot::Pose poseB(0, 2);
         * // find the pose in between the 2 poses
         * Robot::Pose result = poseA.lerp(poseB, 0.5);
         ...
         * @code {.cpp}
         * // create poses
         * Robot::Pose poseA(-1, -2);
         * Robot::Pose poseB(2, 1);
         ...
         * Robot::Pose pose(1, 0);
         * // rotate pose by pi/2
         * Robot::Pose result = pose.rotate(M_PI_2);
         * // result.x = 0, result.y = 1
         * @endcode
         */
