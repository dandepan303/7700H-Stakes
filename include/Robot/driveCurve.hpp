 ...
 * see https://www.vexforum.com/t/expo-drive-Robots-implementation for a detailed explanation
 */
class ExpoDriveCurve : public DriveCurve {
    public:
         ...
         * Robot::ExpoDriveCurve driveCurve(5, 12, 1.132);
         * @endcode
         */
