...
class OdomSensors {
    public:
         ...
         * Robot::TrackingWheel vertical1(&vertical_rotation, Robot::Omniwheel::NEW_275, 0.5);
         * Robot::OdomSensors sensors(&vertical1, // vertical tracking wheel
...
class ControllerSettings {
    public:
         ...
         * @b Example
         * @code {.cpp}
         * Robot::ControllerSettings lateralSettings(10, // proportional gain (kP)
...
class Drivetrain {
    public:
         ...
         *
         * Robot::Drivetrain drivetrain(&leftMotors, // left motor group
         *                               &rightMotors, // right motor group
         *                               10, // 10 inch track width
         *                               Robot::Omniwheel::NEW_4, // using new 4" omnis
...
class Chassis {
    public:
         ...
         * @code {.cpp}
         * // set the pose of the chassis to x = 0, y = 0, theta = 0
         * Robot::Pose poseA(0, 0, 0);
         * chassis.setPose(poseA);
         * // set the pose of the chassis to x = 5.3, y = 12.2, theta = 3.14
         * // this time with theta in radians
         * Robot::Pose poseB(5.3, 12.2, 3.14);
