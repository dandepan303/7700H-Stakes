...
class TrackingWheel {
    public:
         ...
         * Robot::TrackingWheel verticalTrackingWheel(&verticalEncoder, Robot::Omniwheel::NEW_275, -5);
         ...
         * Robot::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, Robot::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * Robot::TrackingWheel leftTrackingWheel(&leftMotors, Robot::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by Robot, this will automatically be called when
         ...
         *     Robot::TrackingWheel exampleTrackingWheel(&exampleEncoder, Robot::Omniwheel::NEW_275, 0.5);
         ...
         *     Robot::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, Robot::Omniwheel::NEW_275, 0.5);
